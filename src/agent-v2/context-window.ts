...
export class ContextWindowManager {
    ...
    private trimSmart(messages: Message[], systemMessage?: Message): Message[] {
        ...
        for (const item of prioritized) {
            ...
            // 检查保留规则
            if (this.options.preserveLastUserMessage && 
     ...
     * 策略 4: 使用总结压缩
     */
    private async trimWithSummarize(messages: Message[], systemMessage?: Message): Promise<Message[]> {
     ...
     * 获取上下文窗口统计信息
     */
    getStats(messages: Message[], systemMessage?: Message): {
