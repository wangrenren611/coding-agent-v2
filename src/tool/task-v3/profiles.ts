...
export const DEFAULT_SUBAGENT_PROFILES: Record<string, SubAgentProfile> = {
  ...
  bash: {
    ...
    maxSteps: 40,
    timeoutMs: 5 * 60_000,
    toolAllowlist: ['bash', 'file_read', 'file_write', 'file_edit', 'file_stat', 'glob', 'grep'],
    memoryMode: 'isolated',
  },
  explore: {
    id: 'explore',
  ...
  plan: {
    ...
    maxSteps: 50,
    timeoutMs: 8 * 60_000,
    toolAllowlist: ['file_read', 'file_write', 'file_edit', 'file_stat', 'glob', 'grep', 'skill'],
    memoryMode: 'isolated',
  },
  'ui-sketcher': {
    id: 'ui-sketcher',
    ...
    maxSteps: 50,
    timeoutMs: 8 * 60_000,
    toolAllowlist: ['file_read', 'file_write', 'file_edit', 'file_stat', 'glob', 'grep', 'bash'],
    memoryMode: 'isolated',
  },
  'bug-analyzer': {
    id: 'bug-analyzer',
